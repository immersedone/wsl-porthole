...
"#;
    ...
    fn test_preview_command() {
        let rule = Rule {
            ...
            listen_port: crate::rules::PortSpec::Single { port: 80 },
            connect_port: crate::rules::PortSpec::Single { port: 80 },
    ...
    fn test_preview_range() {
        let rule = Rule {
            ...
            direction: Direction::WinToWsl,
            listen_addr: "0.0.0.0".into(),
            listen_port: crate::rules::PortSpec::Range { start: 1024, end: 1026 },
            connect_port: crate::rules::PortSpec::Range { start: 1024, end: 1026 },
            connect_addr: "${WSL_IP}".into(),
            distro: None,
            lan: true,
            enabled: true,
